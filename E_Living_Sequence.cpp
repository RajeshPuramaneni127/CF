...
void solve(){
    ...
    for(int i=0;i<s.length();i++) if(s[i]=='8') s[i] = '9';
    for(int i=0;i<s.length();i++) if(s[i]=='7') s[i] = '8';
    for(int i=0;i<s.length();i++) if(s[i]=='6') s[i] = '7';
    for(int i=0;i<s.length();i++) if(s[i]=='5') s[i] = '6';
    for(int i=0;i<s.length();i++) if(s[i]=='4') s[i] = '5';
    cout<<s<<endl;
    return;
}
signed main(){
