...
void solve(){
    int n;cin>>n;
    // no of negative ala ante no. of neg val before this index theliyali!
    // tharvathe em theliyali ante parity count for prathi index 
    int x,count=0,odd=0,even=1,neg=0;
    for(int i=0;i<n;i++){
        cin>>x;
        if(x<0) count++;
        if(count%2){
